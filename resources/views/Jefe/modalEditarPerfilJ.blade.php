<!-- Modal -->
<div class="modal fade" id="modalEditarPerfilJ" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalEditarPerfilJ" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" id="modal">
        ...
        <div class="modal-body">
          ...
          <form class="m-4" method="post" action="{{route('jefe.update')}}" enctype="multipart/form-data">
