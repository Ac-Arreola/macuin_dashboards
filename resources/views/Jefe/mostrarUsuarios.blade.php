...
<div class="container mt-5 col-md-10 mb-5" >
          ...
          <form action="" method="GET" class="form-inline my-2-lg-0 float-right" id="fo">
              ...
              <div class="input-group mb-3 d-grid gap-2 d-md-flex justify-content-md-end">
                <div class="row g-3">
                    <div class="col-auto">
                      <input type="text" name ="busquedaUsuario" class="form-control text-center form-control" 
                      placeholder="Buscar usuario"  id="in" height="35">
                    </div>
                    <div class="col-auto">
          ...
          <table class=" table text-center text-white" id="hey">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" data-bs-toggle="modal" id ="b"data-bs-target="#editarUsuario-{{$consulta->id_usu}}">
                      <img src={!! asset('img\editar.png') !!} id="opciones"alt="" >
                    </button>
                  </td>
                  <td>
                    <button type="button" data-bs-toggle="modal" id ="b"data-bs-target="#eliminarUsuario-{{$consulta->id_usu}}">
