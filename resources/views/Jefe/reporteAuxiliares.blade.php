...
<head>
    ...
    <title>Reporte Auxiliares</title>
  ...
  margin-right: auto; background-color:rgba(220, 149, 220, 0.955); opacity:0.4;">
      <thead>
        <tr>
          ...
          <th scope="col" style="padding: 4px;  border: 1px solid purple;">Apellido paterno</th>
          <th scope="col" style="padding: 4px;  border: 1px solid purple;">Apellido materno</th>
          <th scope="col" style="padding: 4px;  border: 1px solid purple;">Correo</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="padding: 4px;  border: 1px solid purple;">{{$consulta->name}}</td>
          <td style="padding: 4px;  border: 1px solid purple;">{{$consulta->Ape_pat}}</td>
          <td style="padding: 4px;  border: 1px solid purple;">{{$consulta->Ape_mat}}</td>
